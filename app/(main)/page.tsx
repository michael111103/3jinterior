...
import { slides, categories, articles } from '@/lib/data'
      ...
      <section id="about" className="py-20 bg-dark-800 border-y border-gold-900/20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6">
          <div className="text-center mb-14">
            <div className="flex items-center justify-center gap-4 mb-3">
              <div className="h-px w-16 bg-gradient-to-r from-transparent to-gold-500" />
              <span className="text-gold-500 text-xs font-body tracking-widest uppercase">Keunggulan Kami</span>
              <div className="h-px w-16 bg-gradient-to-l from-transparent to-gold-500" />
            </div>
            <h2 className="font-display text-4xl md:text-5xl font-bold text-cream mb-4">
              Mengapa <span className="gold-text">3J Interior?</span>
            </h2>
          </div>
          ...
          {latestArticles.map((article) => (
            <Link key={article.id} href={`/articles/${article.slug}`} className="glass-card rounded-xl overflow-hidden group product-card">
              <div className="aspect-video relative overflow-hidden">
                ...
                />
                <div className="absolute bottom-0 left-0 right-0 h-1/4 bg-gradient-to-t from-dark-900/50 to-transparent" />
              </div>
              <div className="p-5">
          ...
          <div className="grid lg:grid-cols-5 gap-8 items-start">
            ...
            <div className="lg:col-span-3">
              <div className="rounded-2xl overflow-hidden gold-border gold-glow h-80 relative">
                <iframe
                  src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3966.0!2d106.7271985!3d-6.1058!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2e69f3e945e34b9d%3A0x5371bf0fdad786a2!2s3J%20Interior%20%3A%20Gudang%20WPC%2C%20Wall%20Panel%2C%20Interior%2C%20Wallboard%2C%20Harga%20Import%2C%20Grosir%20dan%20Murah!5e0!3m2!1sen!2sid!4v1714000000000!5m2!1sen!2sid"
                  width="100%"
                  height="100%"
